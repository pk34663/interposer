...
void create_adminport(void)
{
    ...
    c = cli_register_command(cli, NULL, "syscall", NULL, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, NULL);
    d = cli_register_command(cli, c, "read", cmd_test, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, NULL);
    cli_register_command(cli, d, "delay", cmd_test, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, NULL);
    ...
    while (1)
    {
        newsockfd = accept(sockfd, NULL, (socklen_t *)&clilen);
